classdef ControlsThicknessTerritoriesGlm
	...
	methods (Static)
        function [mdl,ds,ttg] = createStudyModel2(varargin)
            ...
            import mlanalysis.*;
            ttg = ControlsThicknessTerritoriesGlm(varargin{:});            
            ds  = ttg.theStudyDataset2;
            mdl = ControlsThicknessTerritoriesGlm.createStudyModelFromDataset(ds);                
        end
        ...
        function  mdl         = createStudyModelFromDataset(ds)
            ...
            fprintf('ControlsThicknessTerritoriesGlm.createModelFromDataset:  ensure that contents of the passed dataset are non-negative');
    ...
    methods        
        function this = ControlsThicknessTerritoriesGlm(varargin)
            ...
            for d = 1:length(dt.fqdns)
                try
                    cd(dt.fqdns{d});
                    fprintf('ControlsThicknessTerritoriesGlm.theStudyDataset is working in %s\n', ...
                            dt.fqdns{d});
                    ...
                    tgd.hoMeanvolFileprefix = ['r' dt.dns{d} 'ho1_g3'];
                    tgd.ooMeanvolFileprefix = ['r' dt.dns{d} 'oo1_g3'];
                    tgd.ocFileprefix        = ['r' dt.dns{d} 'oc1_g3'];
                    tgd.oefnqFileprefix     =  'oefnq_default_101010fwhh';
        ...
        function this = accumulateDataset(this, glmDirector, datasetName)
            if (this.datasetSwitches(datasetName))
                try
                    ...
                    fprintf('\nControlsThicknessTerritoriesGlm.accumulateDataset.vname->%s\n\t%s\n', ...
    ...
    methods (Access = 'private')        
        function this = setupDatasetSwitches(this)
            ...
            this.datasetSwitches_ = containers.Map( ...
                ControlsThicknessTerritoriesGlm.PREDICTORS, ...
                this.values2logical(ControlsThicknessTerritoriesGlm.PREDICTOR_SWITCHES));
        end
